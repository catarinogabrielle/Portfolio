    ...
    <>
      ...
      <div className='max-w-[940px] mx-auto p-2 pt-[120px]'>
        ...
        <div className='bg-[#d0d4d6] my-4 p-4 w-full flex justify-between items-center'>
          <h2 className='text-center'>Gabrielle Catarino</h2>
          <div className='flex'>
            <a
              href='https://www.linkedin.com/in/gabrielle-de-castro-santos-catarino-077ab9191'
              target='_blank'
              rel='noreferrer'
            >
            ...
            <a
              href='https://github.com/catarinogabrielle'
              target='_blank'
              rel='noreferrer'
            >
        ...
        <div className='text-center py-4 text-xl font-bold uppercase tracking-wider'>
          <div className='hidden sm:block'>
            <p>Proven Leadership <span className='px-1'>|</span> Web Development{' '}<span className='px-1'>|</span> Complex Problem Solving<span className='px-1'><br></br></span> Mobile Development</p>
          </div>
